...
Compute dangerous weights/scores for each crime location in the crime data.
...
This file has all functions that are used for choosing the safest route.
   
##### Get_route_for_map.py

Call the functions in the "Choose_safest_route.py" to return results.
